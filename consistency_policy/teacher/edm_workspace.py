...
class EDMWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        # configure model
        self.model: KarrasUnetHybridImagePolicy = hydra.utils.instantiate(cfg.policy)

        self.ema_model: KarrasUnetHybridImagePolicy = None
