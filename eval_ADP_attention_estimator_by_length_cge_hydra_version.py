...
def main(cfg: OmegaConf):
    ...
    assert type(policy) in [CTMPPUnetHybridLowdimPolicy, CTMPPUnetHybridImagePolicy], f"Policy type: {type(policy)} it should be in [CTMPPUnetHybridLowdimPolicy, CTMPPUnetHybridImagePolicy]"
