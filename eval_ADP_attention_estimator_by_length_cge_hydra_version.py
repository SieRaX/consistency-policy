...
from consistency_policy.student.ctm_lowdim_policy import CTMPPUnetHybridLowdimPolicy
from omegaconf import OmegaConf
...
def main(cfg: OmegaConf):
    ...
    attention_estimator = Seq2SeqTransformer(obs_dim=checkpoint_cfg.task.obs_dim*2, action_dim=checkpoint_cfg.task.action_dim, seq_len=checkpoint_cfg.policy.horizon)
    ...
    assert type(policy) == CTMPPUnetHybridLowdimPolicy
