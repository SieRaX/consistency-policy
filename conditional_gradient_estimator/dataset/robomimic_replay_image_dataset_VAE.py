...
class RobomimicReplayImageDatasetWrapper(Dataset):
    def __init__(self, root_dataset, vae_checkpoint, vae_latent_dim=64, vae_input_size=240, n_obs_steps=2, device='cuda:0'):
        ...
        self.vae = VAE(latent_dim=vae_latent_dim, input_size=vae_input_size)
